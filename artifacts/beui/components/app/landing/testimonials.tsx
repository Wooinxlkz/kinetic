...
// NOTE: tweet 2069459958857650245 has been deleted — omitted to silence the warning.
const TWEET_IDS = [
  "2070915664668512304",
  "2073486052665537002",
  "2073135185370227162",
...
// Cache all tweet fetches server-side for 1 hour so that repeated page loads
// (and dev-mode re-renders) do not hammer Twitter's syndication API 17 times
// per request. Without this cache the homepage TTFB blocks on 17 serial-ish
// network round-trips.
const fetchTweets = unstable_cache(
  async () => {
