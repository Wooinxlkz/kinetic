...
import { ICON_COUNT } from "@/lib/icons-registry";

const HEADLINE = ["The interface toolkit", "for React & Next.js"];
...
export function Hero() {
  ...
  return (
    <div className="mx-auto max-w-7xl text-center">
      ...
      >
        A copy-paste library of animated components and icons for React,
        powered by Framer Motion and Tailwind. Free and open source.
      </motion.p>
