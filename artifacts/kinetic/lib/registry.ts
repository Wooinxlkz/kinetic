...
export const registry: CategoryEntry[] = [
  {
    ...
    components: [
      ...
      },
      {
        ...
        name: "Marker",
        group: "Typography",
        description: "Animated text annotation that draws a highlight, underline, wavy squiggle, or encircling stroke over any inline text. Spring-driven SVG path animation with six colour presets and reduced-motion support.",
        file: "components/motion/marker.tsx",
        badge: "new",
        launchedAt: "2026-07-16",
        tags: ["typography", "animation", "display", "text"],
      },
      {
        slug: "combobox",
        name: "Combobox",
